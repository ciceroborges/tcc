      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">
            {{
              `${
                this.target.new_record ? "Adicionar" : "Gerenciar"
              } atendimento:`
            }}
          </h4>
        </div>
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
            <li @click="activeTab('appointment')" class="active">
              <a href="#appointment" data-toggle="tab" aria-expanded="true"
                >Atendimento</a
              >
            </li>
            <li @click="activeTab('sessions')" class="">
              <a href="#sessions" data-toggle="tab" aria-expanded="false"
                >Sessões</a
              >
            </li>
          </ul>
